...
public:
	...
	//inputlayout作成(シェーダ―リフレクション)
	DXGI_FORMAT GetDxgiFormat(D3D10_REGISTER_COMPONENT_TYPE type, BYTE mask);
	ID3D11InputLayout* CreateInputLayoutReflection(const string& filename, const string& entrypath, vector<string> macros = vector<string>());
